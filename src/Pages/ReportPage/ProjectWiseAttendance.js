                ...
                <Grid container spacing={2} sx={{my: 2}} alignItems="center" justifyContent="end">
                    ...
                    <Grid item xs={12} md={4}>
                        <Controller
                            render={({field, formState}) => (
                                <FormControl fullWidth size="small">
                                    <Typography color={!!formState.errors?.leaveType ? red[700] : ""}>Select Year*</Typography>
                                    <Select
                                        {...field}
                    ...
                    <Grid item xs={12} md={4}>
                        <Controller
                            render={({field, formState}) => (
                                <FormControl fullWidth size="small">
                                    <Typography color={!!formState.errors?.leaveType ? red[700] : ""}>Select Project*</Typography>
                                    <Select
                                        {...field}
                                        error={!!formState.errors?.leaveType}
                                    >
...
export default ProjectWiseAttendance;